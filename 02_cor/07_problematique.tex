...
%
\footnote{Dans un jeu vid\'eo, un \emph{boss} est un type de créature puissante qui représente généralement un défi important, une étape décisive de l'histoire ou une étape importante d'une zone. Il génère plus d'expérience et permet de ramasser des objets plus rares que les créatures normales.}
% 
