...
Lors de la création d'un jeu vidéo plusieurs mécaniques de \emph{gameplay} sont sélectionnées afin de générer l'expérience voulue par le \emph{game designer}. L'ensemble de ces mécaniques de \emph{gameplay} réunies en un seul jeu définissent le genre de ce jeu.

Exemple : Dans le cas d'un \emph{BattleRoyal} (définit dans la liste ci-dessous~\ref{I_BR}), on allie les mécaniques de \emph{gameplay} de \emph{survival} et de \emph{last-man-standing} afin de créer le genre \emph{BattleRoyal}.
