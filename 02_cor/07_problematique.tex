...
%
Par 
exemple, dans le cas d'un \emph{Battle Royale} (défini dans la liste ci-dessous), on allie les mécaniques de \emph{gameplay} de \emph{Survival} et de \emph{Last Man Standing} afin de créer le genre \emph{Battle Royale}.
