...
Dans un MMORPG --- \emph{Massive Multiplayer Online Role-Playing Game}, un genre de jeu vidéo défini \`a la Section~\ref{MMORPG} --- une mécanique de jeu pourrait \^etre comme suit :
\begin{itemize}
...
Prenon le cas précédent de no-tre \emph{boss} de glace.
\begin{itemize}
...
Ainsi, un type de mécanique de jeu réellement plus puissant que les autres enlèverait une partie du <<~fun~>> ressenti par le joueur, car ce ne serait plus une question de choix, mais juste une question de calculs.
