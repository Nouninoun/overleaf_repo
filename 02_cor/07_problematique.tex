...
\GT{Le titre de la sous-section devrait correspondre \`a ce qui est indiqu\'e dans la figure~1.1.}
...
\GT{Idem pour les deux sous-sections qui suivent, qui n'apparaissent pas dans la figure.}
...
\GT{On reverra cette section ult\'erieurement. Une partie de cela
devrait \^etre dans l'introduction.}


\GT{Je ne comprends pas <<se rejoignent>>!?}
...
\GT{Qu'est qu'un <<paper board>> vs. feuille de papier?}
