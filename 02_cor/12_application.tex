...
\footnote{Jeu \emph{standalone} : Logiciel informatique qui peut s'exécuter de manière indépendante \GT{Je ne comprends pas: Ind\'ependante de quoi? D'une machine? D'une plateforme de jeu?}}
%
...
\ACOMPLETER{La Figure~\ref{fig.modelisation_application} pr\'esente...}
...
\begin{figure}
    \centering
    \includegraphics[width=7cm]{10_img/chap6/attack_min.PNG}
