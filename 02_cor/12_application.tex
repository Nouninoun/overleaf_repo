...
\ACOMPLETER{Ici, il faudrait décrire un peu les éléments de cette
figure. Pas tous, mais ceux qui te semblent particulièrement
intéressants ou signficatifs pour expliquer PUBG. Ce que je veux dire,
en gros, c'est de décrire en quelques mots/phrases certains morceaux
du diagramme --- classes et associations reliées.}
