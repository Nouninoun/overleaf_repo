...
Dans la figure~\ref{fig.uml_but_definition}, on peut remarquer la présence d'une flêche noire à tête pleine entre les éléments "\texttt{<<stereotype>> Bouton}" et "\texttt{<<metaclass>>~Class}".
