...
Un outil permettant de modéliser les besoins, les données et la conception d'un logiciel existe déjà : \glsfirst{uml}. UML permet de mod\'eliser tous ces aspects, mais peut également être adapté à un domaine d'application particulier à travers les \emph{profils UML}. C'est ce que nous présentons dans le présent chapitre.
