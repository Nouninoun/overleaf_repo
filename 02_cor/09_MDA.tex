...
Dans la figure~\ref{fig.dpe} les flèches représentent les relations entre le \emph{Game designer}, le jeu et le joueur. Le \emph{Game designer} con\c{c}oit (\emph{Design}) le jeu, le joueur joue (\emph{Play}) au jeu, et il en résulte une expérience de jeu (\emph{Experience}). 
