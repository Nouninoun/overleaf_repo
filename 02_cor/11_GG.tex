...
\begin{figure}[H]
    ...
    \caption{Les stéréotypes appliqués à la  <<~metaclass~>> Classe}
...
\begin{figure}[H]
    ...
    \caption{Les stéréotypes appliqués à la  <<~metaclass~>> Association}
...
Dans un profile UML il est fréquent d'imposer des contraintes d'utilisation du profile afin de le rendre plus précis et d'éviter des problèmes de compréhension ou d'incohérence du modèle.
Dans \emph{Game Genesis} il est compliqué d'établir un grand nombre de contraintes, le profil devant s'appliquer à de nombreux types de \emph{gameplays}.
...
Voici une liste des contraintes envisageables dans un profil tel que \emph{Game Genesis} :
\begin{itemize}
