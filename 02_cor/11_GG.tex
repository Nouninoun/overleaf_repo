...
La figure~\ref{fig.meta_class} \ACOMPLETER{expliquer le rôle de cette
figure, ce qu'elle représente --- et le fait qu'il ne s'agit que d'un
extrait!}
...
%
\ACOMPLETER{Il faut dire quelques mots sur la\ldots} Figure~\ref{fig.meta_assoc}.
...
\ACOMPLETER{Synthétiser {\bf brièvement} ce qui a été fait, en
indiquant aussi, dès à présent, les limites --- juste Mechanics,
inspiré principalement de X, profil spécéfié de façon informel (pas
dans un outil). Mais tu vas quand même l'utiliser pour décrire les
éléments de Mechanics d'un jeu.}
