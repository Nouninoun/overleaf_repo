\chapter{Un profil UML pour la rédaction de GDD: \emph{Game Genesis}}
...
\begin{figure}
    ...
    \caption[La spécification de certains stéréotypes de \emph{Game Genesis}.]{La spécification de certains stéréotypes de \emph{Game Genesis}, obtenus par \emph{extension} de la m\'etaclasse \texttt{Class}.}
...
\begin{figure}
    ...
    \caption[Une classe \texttt{Sniper1} utilisant le stéréotype \texttt{SniperRifle}.]{Une classe \texttt{Sniper1} utilisant le stéréotype
...
\begin{figure}
    ...
    \caption[La spécification du stéréotype \texttt{Interaction} de \emph{Game Genesis}.]{La spécification du stéréotype \texttt{Interaction} de \emph{Game Genesis}, obtenu par \emph{extension} de la m\'etaclasse \texttt{Association}.}
