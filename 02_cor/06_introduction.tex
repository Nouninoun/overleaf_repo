...
%quoi
Dans ce mémoire, nous présentons \gls{gg}, un profil~UML qui permet d'outiller le processus de \AVERIFIER{pré-}conception d'un jeu vidéo, facilitant ainsi la documentation et la rédaction des documents descriptifs du jeu vidéo en cours d'élaboration.
...
\emph{Breaktrough} et \AVERIFIER{Pré-}conception, le profil \emph{Game Genesis}
...
Nous y présentons le contenu d'un \emph{Concept Document}, d'un \emph{Executive Summary} et d'un \emph{Game Design Document}.
