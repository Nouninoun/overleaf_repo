...
Librane présente également les <<\emph{design wikis}>> qui apportent de nombreux points positifs au design.
...
\AVERIFIER{L'id\'ee g\'en\'erale d'un <<\emph{concept document}>> est
...
\begin{itemize}
    ...
    \item Démontrer et décrire les sujets. \GT{Qu'est-ce qu'un <<sujet>>!?}
...
Certaines parties du jeu peuvent également en obstruer d'autres : trop de détails dans la description d'une mécanique peut éclipser le fait qu'une autre \ACOMPLETER{Une autre quoi: partie? m\'ecanique?} n'est pas assez détaillée.
