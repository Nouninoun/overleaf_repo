...
\item La première page contient ce que le \emph{One-Page} décrivait auparavant, soit un aperçu concis des caractéristiques du jeu ainsi qu'un calendrier \AVERIFIER{de d\'eveloppement}.
...
\item La page 9 contient ce qui accompagne le jeu mais de l'extérieur : des succès à remplir selon la plateforme, des secrets et \emph{easter-eggs}.%
\footnote{Un secret peut être un niveau ou un objet collectionnable, un \emph{easter-egg} quant à lui est une blague glissée dans un jeu par un développeur ou par l'équipe de développement.}
