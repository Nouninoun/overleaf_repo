...
\item La page 9 contient ce qui accompagne le jeu mais de l'extérieur : des succès à remplir \footnote{Selon la plateforme sur laquelle un jeu est publié il peut être accompagné de <<~succès~>>. Ce sont des tâches à accomplir qui donnent le droit à un trophée ou une récompense quelconque. Ex : <<~Tuer 3000 souris dans une partie~>>} , des secrets et \emph{easter-eggs} \footnote{Un secret peut être un niveau ou un objet collectionnable, un \emph{easter-egg} quant à lui est une blague glissée dans un jeu par un développeur ou par l'équipe de développement.}.
