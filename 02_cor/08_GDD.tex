...
\begin{itemize}
    ...
    \item Mettre à disposition le GDD dans de bonnes conditions, c'est à dire que le contenu du GDD doit être consistant du début à la fin, en respectant une structure cohérente et un contenu détaillé et mis à jours régulièrement.
\end{itemize}
